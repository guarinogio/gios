...
RELEASE_ENV="$HOME/.config/azunain/gios/release.env"
...
print(int(data.get("version_code", 1)))
PY
)
...
echo "output:       exports/android/${ID}-release.aab"
...
echo
echo "AAB created:"
ls -lh "exports/android/${ID}-release.aab"
